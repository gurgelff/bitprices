...
var $author$project$Main$RequestPrice = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$pairsDecoder = function (currency) {
	return A2(
...
var $author$project$Main$getPrice = function (val) {
	return $elm$http$Http$get(
		{
			aw: A2(
				$elm$http$Http$expectJson,
				$author$project$Main$RequestPrice,
				$author$project$Main$pairsDecoder(val)),
			aP: 'https://api.coindesk.com/v1/bpi/currentprice.json'
		});
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Loading,
		$author$project$Main$getPrice('USD'));
};
...
var $author$project$Main$Fail = {$: 1};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				$author$project$Main$Loading,
				$author$project$Main$getPrice(currency));
		} else {
			var result = msg.a;
			if (!result.$) {
				var val = result.a;
				...
				return _Utils_Tuple2($author$project$Main$Fail, $elm$core$Platform$Cmd$none);
			}
		}
	});
var $author$project$Main$InitReq = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$customView = function (model) {
	switch (model.$) {
		case 1:
			return $elm$html$Html$text(' An error occured while fetching the data. Please reaload the page or try again later');
		case 0:
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$customView(model),
						...
						_List_fromArray(
							[
								...
								function (currency) {
									return $author$project$Main$InitReq(currency);
								})
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('EUR')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value('GBP')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('GBP')
									]))
							]))
					]))
			]));
